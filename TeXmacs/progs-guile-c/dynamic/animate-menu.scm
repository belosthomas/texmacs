...
(tm-define (accelerate-icon type)
  (cond ((== type "fade-in") "tm_anim_fade_in")
        ((== type "fade-out") "tm_anim_fade_out")
        ((== type "faded") "tm_anim_faded")
        ((== type "bump") "tm_anim_bump")
        ((== type "reverse") "tm_anim_reverse")
        ((== type "reverse-fade-in") "tm_anim_reverse_fade_in")
        ((== type "reverse-fade-out") "tm_anim_reverse_fade_out")
        ((== type "reverse-faded") "tm_anim_reverse_faded")
        ((== type "reverse-bump") "tm_anim_reverse_bump")
        (else "tm_anim_normal")))
...
(define (translate-icon x y)
  (cond ((and (= x -1) (= y  0)) "tm_right")
        ((and (= x  1) (= y  0)) "tm_left")
        ((and (= x  0) (= y -1)) "tm_up")
        ((and (= x  0) (= y  1)) "tm_down")
        ((and (= x -1) (= y -1)) "tm_right_up")
        ((and (= x -1) (= y  1)) "tm_right_down")
        ((and (= x  1) (= y -1)) "tm_left_up")
        ((and (= x  1) (= y  1)) "tm_left_down")
        (else "tm_customized")))
...
(define (progressive-icon l b r t inv?)
  (cond ((and (= l 0.5) (= r 0.5) (= b 0.5) (= t 0.5))
         (if inv? "tm_customized" "tm_outwards"))
        ((and (= l 0) (= r 0) (= b 0) (= t 0)) "tm_right_up")
        ((and (= l 0) (= r 0) (= b 1) (= t 1)) "tm_right_down")
        ((and (= l 1) (= r 1) (= b 0) (= t 0)) "tm_left_up")
        ((and (= l 1) (= r 1) (= b 1) (= t 1)) "tm_left_down")
        ((and (= l 0) (= r 0) (= b 0) (= t 1)) "tm_right")
        ((and (= l 1) (= r 1) (= b 0) (= t 1)) "tm_left")
        ((and (= b 0) (= t 0) (= l 0) (= r 1)) "tm_up")
        ((and (= b 1) (= t 1) (= l 0) (= r 1)) "tm_down")
        (else "tm_customized")))
...
(tm-menu (focus-toggle-icons t)
  (:require (tree-is? t 'anim-edit))
  ((balloon (icon "tm_search_next") "Play animation")
   (current-anim-commit)))
  
(tm-menu (focus-toggle-icons t)
  (:require (tree-in? t '(anim-static anim-dynamic)))
  ((balloon (icon "tm_show_hidden") "Edit animation")
...
(tm-menu (animate-toolbar)
  (with t (tree-innermost user-anim-context? #t)
    (hlist
      (assuming (not t)
        ((balloon (icon "tm_search_next") "Play all animations")
      ...
      (assuming (tree-in? t '(anim-static anim-dynamic))
        ...
        ((balloon (icon "tm_show_hidden") "Edit animation")
         (current-anim-checkout)
         (notify-change 256))
        ((balloon (icon "tm_focus_delete") "Remove animation")
         (current-anim-remove))
        // // //
        (dynamic (anim-duration-field "Duration" t 1))
        (dynamic (anim-step-field "Step" t 2)))
      (assuming (tree-in? t '(anim-edit))
        ...
        (assuming (anim-can-remove-frame? t)
          ((balloon (icon "tm_remove") "Remove this frame")
