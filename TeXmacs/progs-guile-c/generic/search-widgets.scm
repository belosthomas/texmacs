...
(tm-widget ((search-widget u style init aux) quit)
  (padded
    ...
    ===
    (hlist
      ((balloon (icon "tm_search_first") "First occurrence")
       (search-extreme-match #f))
      ((balloon (icon "tm_search_previous") "Previous occurrence")
       (search-next-match #f))
      ((balloon (icon "tm_search_next") "Next occurrence")
       (search-next-match #t))
      ((balloon (icon "tm_search_last") "Last occurrence")
       (search-extreme-match #t))
      >>>
      (=> (balloon (icon "tm_preferences") "Search preferences")
          (link search-preferences-menu))
      ((check (balloon (icon "tm_filter") "Only show paragraphs with hits")
      ...
      ((balloon (icon "tm_close_tool") "Close search tool")
       (quit)))))
  ...
  (padded
    ...
    (hlist
      ...
      ((balloon (icon "tm_search_last") "Last occurrence")
       (search-extreme-match #t))
      // // //
      ((balloon (icon "tm_replace_one") "Replace one occurrence")
       (replace-one))
      ((balloon (icon "tm_replace_all") "Replace all further occurrences")
       (replace-all))
      >>>
      (=> (balloon (icon "tm_preferences")
      ...
      ((balloon (icon "tm_close_tool") "Close replace tool")
       (quit)))))
