...
;(texmacs::application::set-initialization-message "Booting TeXmacs kernel functionality")
...
;(texmacs::application::set-initialization-message "Booting utilities")
...
;(texmacs::application::set-initialization-message "Booting BibTeX style modules")
...
;(texmacs::application::set-initialization-message "Booting main TeXmacs functionality")
...
;(texmacs::application::set-initialization-message "Booting generic mode")
...
;(texmacs::application::set-initialization-message "Booting text mode")
...
;(texmacs::application::set-initialization-message "Booting math mode")
...
;(texmacs::application::set-initialization-message "Booting source mode")
...
;(texmacs::application::set-initialization-message "Booting table mode")
...
;(texmacs::application::set-initialization-message "Booting graphics mode")
...
;(texmacs::application::set-initialization-message "Booting formal and natural languages")
...
;(texmacs::application::set-initialization-message "Booting educational features")
(lazy-keyboard (education edu-kbd) in-edu-text?)
(lazy-menu (education edu-menu) edu-insert-menu)
;(display* "time: " (- (texmacs-time) boot-start) "")
;(display* "memory: " (texmacs-memory) " bytes")

;(texmacs::application::set-initialization-message "Booting dynamic features")
...
;(texmacs::application::set-initialization-message "Booting documentation")
...
;(texmacs::application::set-initialization-message "Booting converters")
...
;(texmacs::application::set-initialization-message "Booting partial document facilities")
...
;(texmacs::application::set-initialization-message "Booting database facilities")
...
;(texmacs::application::set-initialization-message "Booting security tools")
...
;(texmacs::application::set-initialization-message "Booting remote facilities")
...
;(texmacs::application::set-initialization-message "Booting linking facilities")
...
;(texmacs::application::set-initialization-message "Booting versioning facilities")
...
;(texmacs::application::set-initialization-message "Booting debugging and developer facilities")
...
;(texmacs::application::set-initialization-message "Booting editing modes for various special styles")
...
;(texmacs::application::set-initialization-message "Booting plugins")
(for-each lazy-plugin-initialize (plugin-list))
;(display* "time: " (- (texmacs-time) boot-start) "")
;(display* "memory: " (texmacs-memory) " bytes")

;(texmacs::application::set-initialization-message "Booting fonts")
...
;(texmacs::application::set-initialization-message "Booting regression testing")
...
(texmacs-banner)
;(texmacs::application::set-initialization-message "Initialization done")
