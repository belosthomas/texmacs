...
tmg_updater_last_check () {
  ...
  return scheme().long_to_tmscm (out);
}
...
tmg_get_retina_factor () {
  ...
  return scheme().int_to_tmscm (out);
}
...
tmg_get_retina_scale () {
  ...
  return scheme().double_to_tmscm (out);
}
...
tmg_scheme_dialect () {
  // TMSCM_DEFER_INTS;
  string out= scheme().scheme_dialect ();
  // TMSCM_ALLOW_INTS;
...
tmg_get_texmacs_path () {
  ...
  return scheme().url_to_tmscm (out);
}
...
tmg_evaluate_system (tmscm arg1, tmscm arg2, tmscm arg3, tmscm arg4) {
  ...
  array_string in1= arg1->to_array_string();
  array_int in2= arg2->to_array_int();
  array_string in3= arg3->to_array_string();
  array_int in4= arg4->to_array_int();
...
tmg_rgba_2named_color (tmscm arg1) {
  ...
  array_int in1= arg1->to_array_int();
...
tmg_glyph_register (tmscm arg1, tmscm arg2) {
  ...
  string in1= arg1->to_string();
  array_array_array_double in2= arg2->to_array_array_array_double();
...
tmg_glyph_recognize (tmscm arg1) {
  ...
  array_array_array_double in1= arg1->to_array_array_array_double();
...
tmg_apply_effect (tmscm arg1, tmscm arg2, tmscm arg3, tmscm arg4, tmscm arg5) {
  ...
  content in1= arg1->to_content();
  array_url in2= arg2->to_array_url();
  url in3= arg3->to_url();
  int in4= arg4->to_int();
  int in5= arg5->to_int();
...
tmg_characteristic_distance (tmscm arg1, tmscm arg2) {
  ...
  array_string in1= arg1->to_array_string();
  array_string in2= arg2->to_array_string();
...
tmg_stree_2tree (tmscm arg1) {
  ...
  scheme_tree in1= arg1->to_scheme_tree();
...
tmg_tree_label_extensionP (tmscm arg1) {
  ...
  tree_label in1= arg1->to_tree_label();
...
tmg_tree_search_tree (tmscm arg1, tmscm arg2, tmscm arg3, tmscm arg4) {
  ...
  content in1= arg1->to_content();
  content in2= arg2->to_content();
  path in3= arg3->to_path();
  int in4= arg4->to_int();
...
tmg_previous_search_hit (tmscm arg1, tmscm arg2, tmscm arg3) {
  ...
  array_path in1= arg1->to_array_path();
  path in2= arg2->to_path();
  bool in3= arg3->to_bool();
...
tmg_navigate_search_hit (tmscm arg1, tmscm arg2, tmscm arg3, tmscm arg4) {
  ...
  path in1= arg1->to_path();
  bool in2= arg2->to_bool();
  bool in3= arg3->to_bool();
  bool in4= arg4->to_bool();
...
tmg_tree_assign_node (tmscm arg1, tmscm arg2) {
  ...
  tree in1= arg1->to_tree();
  tree_label in2= arg2->to_tree_label();
...
tmg_concat_recompose (tmscm arg1) {
  ...
  array_tree in1= arg1->to_array_tree();
...
tmg_path_next_tag (tmscm arg1, tmscm arg2, tmscm arg3) {
  ...
  content in1= arg1->to_content();
  path in2= arg2->to_path();
  scheme_tree in3= arg3->to_scheme_tree();
...
tmg_modification_kind (tmscm arg1) {
  ...
  modification in1= arg1->to_modification();
...
tmg_modification_applicableP (tmscm arg1, tmscm arg2) {
  ...
  content in1= arg1->to_content();
  modification in2= arg2->to_modification();
...
tmg_patch_compound (tmscm arg1) {
  ...
  array_patch in1= arg1->to_array_patch();
...
tmg_tmdb_set_field (tmscm arg1, tmscm arg2, tmscm arg3, tmscm arg4, tmscm arg5) {
  ...
  string in2= arg2->to_string();
  string in3= arg3->to_string();
  array_string in4= arg4->to_array_string();
...
tmg_tmdb_query (tmscm arg1, tmscm arg2, tmscm arg3, tmscm arg4) {
  ...
  url in1= arg1->to_url();
  scheme_tree in2= arg2->to_scheme_tree();
  double in3= arg3->to_double();
  int in4= arg4->to_int();
...
tmg_widget_color_picker (tmscm arg1, tmscm arg2, tmscm arg3) {
  ...
  command in1= arg1->to_command();
  bool in2= arg2->to_bool();
  array_tree in3= arg3->to_array_tree();
...
tmg_widget_extend (tmscm arg1, tmscm arg2) {
  ...
  widget in1= arg1->to_widget();
  array_widget in2= arg2->to_array_widget();
...
tmg_widget_hmenu (tmscm arg1) {
  ...
  array_widget in1= arg1->to_array_widget();
...
tmg_widget_icon_tabs (tmscm arg1, tmscm arg2, tmscm arg3) {
  ...
  array_url in1= arg1->to_array_url();
  array_widget in2= arg2->to_array_widget();
  array_widget in3= arg3->to_array_widget();
...
tmg_widget_resize (tmscm arg1, tmscm arg2, tmscm arg3, tmscm arg4, tmscm arg5, tmscm arg6, tmscm arg7, tmscm arg8, tmscm arg9, tmscm arg10) {
  ...
  string in4= arg4->to_string();
  string in5= arg5->to_string();
  string in6= arg6->to_string();
  string in7= arg7->to_string();
  string in8= arg8->to_string();
  string in9= arg9->to_string();
  string in10= arg10->to_string();
